...
Here are the first six lines of a `.csv` file containing **data from a [Fitbit tracker](https://www.fitbit.com/en-ca/charge2)**. It is called `fitbit-acivity.csv` and is **located in the `docs` directory of this project**:
...
Let's open the same `fitbit-acivity.csv` file with the `read.delim()` function:

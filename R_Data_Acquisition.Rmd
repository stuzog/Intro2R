...
**`read.table` is slow to read large files into memory**. Two other packages provide function that are faster and better in that they do not automatically convert _character data_ to _factors_:

...
The [`reader`](https://readr.tidyverse.org/) package enables reading many kinds of text files:
...
This example loads a sample `.csv` file bundled with `readr`, which is returned as a [_tibble_](https://github.com/tidyverse/tibble), a modern re-imagining of the _data.frame_:
...
`readr` is much faster than `read.table`
